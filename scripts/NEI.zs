...
NEITweaker.hideAllItems(<TConstruct:ShortBow>);
NEITweaker.hideAllItems(<TConstruct:dagger>);
NEITweaker.hideAllItems(<TConstruct:BoltAmmo>);
NEITweaker.hideAllItems(<TConstruct:ArrowAmmo>);
NEITweaker.hideAllItems(<TConstruct:Crossbow>);
NEITweaker.hideAllItems(<TConstruct:LongBow>);
NEITweaker.hideAllItems(<TConstruct:Javelin>);
NEITweaker.hideAllItems(<TConstruct:ThrowingKnife>);
NEITweaker.hideAllItems(<TConstruct:Shuriken>);
NEITweaker.hideAllItems(<TConstruct:battleaxe>);
NEITweaker.hideAllItems(<TConstruct:hammer>);
NEITweaker.hideAllItems(<TConstruct:excavator>);
NEITweaker.hideAllItems(<TConstruct:scythe>);
NEITweaker.hideAllItems(<TConstruct:cleaver>);
NEITweaker.hideAllItems(<TConstruct:lumberaxe>);
NEITweaker.hideAllItems(<TConstruct:chisel>);
NEITweaker.hideAllItems(<TConstruct:mattock>);
NEITweaker.hideAllItems(<TConstruct:battlesign>);
NEITweaker.hideAllItems(<TConstruct:frypan>);
NEITweaker.hideAllItems(<TConstruct:cutlass>);
NEITweaker.hideAllItems(<TConstruct:rapier>);
NEITweaker.hideAllItems(<TConstruct:longsword>);
NEITweaker.hideAllItems(<TConstruct:broadsword>);
NEITweaker.hideAllItems(<TConstruct:hatchet>);
NEITweaker.hideAllItems(<TConstruct:shovel>);
NEITweaker.hideAllItems(<TConstruct:pickaxe>);
...
NEITweaker.hideItems(<TConstruct:toolRod>, [3, 608] as int[]);
NEITweaker.hideItems(<TConstruct:pickaxeHead>, [4, 5, 6, 8, 9, 17, 656, 1000] as int[]);
NEITweaker.hideItems(<TConstruct:shovelHead>, [4, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:hatchetHead>, [4, 8, 9, 17, 55, 656, 1000, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:swordBlade>, [0, 4, 5, 6, 7, 8, 9, 17, 55, 1000, 31, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:wideGuard>, [0, 3, 4, 5, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:handGuard>, [0, 3, 4, 5, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:crossbar>, [3, 4, 8, 9, 17, 55, 656, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:binding>, [3, 5, 14, 55, 656, 598, 608, 1024, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:frypanHead>, [0, 3, 4, 5, 6, 7, 8, 9, 17, 656, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:signHead>, [3, 4, 5, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:knifeBlade>, [0, 6, 7, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:chiselHead>, [0, 3, 4, 5, 7, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:toughRod>, [0, 3, 4, 5, 6, 8, 9, 17, 55, 656, 608, 1000, 31] as int[]);
NEITweaker.hideItems(<TConstruct:toughBinding>, [0, 3, 4, 5, 6, 8, 9, 17, 55, 656, 598, 508, 1024, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:heavyPlate>, [0, 3, 4, 5, 8, 9, 17, 55, 656, 598, 608, 1024, 1000] as int[]);
NEITweaker.hideItems(<TConstruct:broadAxeHead>, [0, 3, 4, 5, 8, 9, 17, 55, 656, 1000, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:scytheBlade>, [0, 3, 4, 5, 8, 9, 17, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:excavatorHead>, [0, 3, 4, 5, 8, 9, 17, 55, 1000, 31, 1025] as int[]);
NEITweaker.hideItems(<TConstruct:largeSwordBlade>, [0, 3, 4, 5, 6, 7, 8, 9, 17, 55, 656, 1000, 31, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:hammerHead>, [0, 3, 4, 5, 7, 8, 9, 17, 1000, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:fullGuard>, [0, 3, 4, 5, 8, 9, 14, 17, 55, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:arrowhead>, [0, 4, 8, 9, 14, 17, 55, 656, 1000, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:ShurikenPart>, [0, 5, 7, 8, 9, 17, 55, 656, 1000, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:CrossbowLimbPart>, [3, 4, 6, 7, 9, 55, 656, 1000, 31, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:CrossbowBodyPart>, [3, 4, 9, 55, 656, 1000, 1025, 1024] as int[]);
NEITweaker.hideItems(<TConstruct:BowLimbPart>, [3, 4, 6, 7, 9, 55, 1000, 31, 1025, 1024] as int[]);
